...
import { Home, User, Code, Rss, Mail, Github, Linkedin, Twitter } from 'lucide-react';
    ...
    <footer className="bg-gray-100 dark:bg-gray-800 pt-6 sticky bottom-0 z-10">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center mb-4">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">&copy; 2023 Your Name. All rights reserved.</p>
        </div>
